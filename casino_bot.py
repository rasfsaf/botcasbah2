...
# Версия: 3.0 - Казино Бабахи (Black Jack 5x, Перебор, С сохранением данных)
# Валюта: Хэш-Фугасы
...
async def main():
    """Запуск бота"""
    print("🎰 Казино БАБАХИ запущено! (Версия 3.0 - Black Jack 5x, Перебор, С сохранением данных)")
    load_users_data()
