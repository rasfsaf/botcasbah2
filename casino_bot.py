...
# Версия: 3.2 - Казино Бабахи (ПОЛНАЯ ВЕРСИЯ - обе версии объединены)
# Валюта: Хэш-Фугасы
...
group_blackjack_games: Dict[int, dict] = {}  # Игры Black Jack в группе по chat_id
...
# =============== BLACK JACK (личная и вспомогательные функции) ===============
...
async def main():
    """Запуск бота"""
    print("🎰 Казино БАБАХИ запущено! (Версия 3.2 - ПОЛНАЯ ВЕРСИЯ с обеими версиями)")
    load_users_data()
